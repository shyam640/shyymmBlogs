          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Shyam Sundar Vashishtha
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+91-8817719155
              </h2>
              <h2 className="font-medium">
              ...
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Joura, Madhya Pradesh, India | Pincode:476221
              </h2>
              <a
